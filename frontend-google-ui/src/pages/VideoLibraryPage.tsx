      ...
      <section className="mx-auto max-w-7xl rounded-2xl border border-white/80 bg-white/90 p-3 shadow-sm md:p-4">
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
          ...
          <div className="flex gap-2 overflow-x-auto">
            {selectedFolder && <button type="button" onClick={() => setSelectedFolder('')} className="whitespace-nowrap rounded-xl bg-slate-100 px-3 py-2 text-xs font-black text-slate-600 hover:bg-slate-200">返回文件夹</button>}
          </div>
