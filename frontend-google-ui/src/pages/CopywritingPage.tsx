...
export default function CopywritingPage({ onBack, onNavigate, onSwitchToVideo, onSwitchToClip, onSwitchToReplica }: CopywritingPageProps) {
    ...
    <div className="flex min-h-screen flex-col bg-background">
      <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center justify-between border-b border-slate-300 bg-white/80 px-6 backdrop-blur-md">
        <div className="flex items-center gap-3">
          ...
          <CreativeSubNav current="copy" onSwitchVideo={onSwitchToVideo ?? (() => {})} onSwitchClip={onSwitchToClip ?? (() => {})} onSwitchCopy={() => {}} onSwitchReplica={onSwitchToReplica} />
        </div>
      </header>
